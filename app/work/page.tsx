  ...
  return (
    <section>
      ...
      <div className="prose prose-neutral dark:prose-invert">
        ...
        <p className="text-neutral-600 dark:text-neutral-400 text-sm">CEO</p>
        <p>
        ...
        <p>
          ...
          GitHub with. It's used by Walmart, ChatGPT, Starbucks, Okta, Datastax,
          Notion, and <a href="https://nextjs.org/showcase">more</a>.
        </p>
        <hr className="my-6 border-neutral-100 dark:border-neutral-800" />
        <h2 className="font-medium text-xl mb-1 tracking-tighter">Not A Bot</h2>
